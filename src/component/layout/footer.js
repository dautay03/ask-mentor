            ...
            <div className="row justify-content-center">             
                <div className="col-7 col-sm-5">
                    ...
                    <address>
		              ...
		              HONG KONG<br />
		              <i className="bi bi-telephone bi-lg"></i>: +852 1234 5678<br />
		              <i className="bi bi-google bi-lg"></i>: +852 8765 4321<br />
		              <i className="bi bi-envelope bi-lg"></i>: <a href="mailto:confusion@food.net">
                         confusion@food.net</a>
                    </address>
                </div>
                <div className="col-12 col-sm-4 align-self-center">
                    <div className="text-center">
                        <a className="btn btn-social-icon btn-google" href="http://google.com/+"><i className="bi bi-google bi-lg"></i></a>
                        ...
                        <a className="btn btn-social-icon" href="mailto:"><i className="bi bi-envelope-o"></i></a>
                    </div>
                </div>
            </div>
            <div className="row justify-content-center">             
