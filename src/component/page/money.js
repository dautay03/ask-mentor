  ...
  return (
    <div className="container row" style={{ margin: "auto" }}>
      ...
      <div className="container row" style={{ padding: "7px" }}>
        <div
          className="col-5 col-md-5 col-lg-2"
          style={{ color: "ButtonHighlight" }}
        >
          <button
            onClick={() => setState({ props: props.money.sort(compare2) })}
          >
        ...
        >
          <button
            onClick={() => setState({ props: props.money.sort(compare3) })}
          >
            Sắp xếp theo mã nhân viên
          </button>
        </div>
        ...
        >
          <button
            onClick={() => setState({ props: props.money.sort(compare1) })}
          >
        ...
        >
          <button
            onClick={() => setState({ props: props.money.sort(compare) })}
          >
            Sắp xếp lương từ nhỏ đến lớn
          </button>
        </div>
      </div>
      {Listmoney}
